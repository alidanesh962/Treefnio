...
const ProductImport: React.FC<ProductImportProps> = ({ onClose, onSuccess }) => {
    ...
    const validateProduct = (product: PreviewProduct): string[] => {
      ...
      const existingProduct = db.getProducts().find(p => 
    ...
    const processCSVFile = async (file: File): Promise<FileData> => {
      ...
      const generatePreview = (): void => {
        ...
        const newProducts: PreviewProduct[] = fileData.rows.map(row => {
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-between items-center mt-8">
            ...
            <button
              ...
              disabled={!columnMapping.name || !columnMapping.code}
      ...
      return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-7xl w-full mx-4 max-h-[90vh] 
